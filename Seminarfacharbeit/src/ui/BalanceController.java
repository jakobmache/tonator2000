...
{	
	...
	{
		module1Label.setText(parent.getInputController().getReferenceContainer().findModuleById(module2Id).getName());
		module2Label.setText(parent.getInputController().getReferenceContainer().findModuleById(module1Id).getName());
