...
{	
	...
	{
		module1Label.setText(parent.getInputController().getSynthesizerContainer().findModuleById(module2Id).getName());
		module2Label.setText(parent.getInputController().getSynthesizerContainer().findModuleById(module1Id).getName());
