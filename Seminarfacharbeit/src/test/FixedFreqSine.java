...
public class FixedFreqSine extends JFrame {
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         public void run() {
            try {
               FixedFreqSine frame = new FixedFreqSine();
   ...
   class SampleThread extends Thread {
      ...
      final static public double BUFFER_DURATION = 0.01;      //About a 100ms buffer
...
// Size in bytes of sine wave samples we'll create on each loop pass 
      ...
      public void run() {
         ...
         ByteBuffer buffer2 = ByteBuffer.allocate(SINE_PACKET_SIZE);
         ...
         while (bExitThread==false) {
           ...
           // line2.write(cBuf.array(), 0, cBuf.position());
