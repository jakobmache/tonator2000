...
public class TestClass extends JFrame {
	...
	class SampleThread extends Thread {
		...
		final static public double BUFFER_DURATION1 = 0.100;      //About a 100ms buffer
		...
		final static public int SINE_PACKET_SIZE = (int)(BUFFER_DURATION1*SAMPLING_RATE*SAMPLE_SIZE); 
